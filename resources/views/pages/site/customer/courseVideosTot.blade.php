                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="video-container">
                                        <div class="video-container" >
                                            <video controls autoplay preload="auto" id="yt-video"
                                                   class="video-js vjs-fill vjs-styles=defaults vjs-big-play-centered"
                                                   data-setup="{}" style="
                                                                                    position: relative;">
                                                <source
                                                    src="{{ asset('videos/'. $video->uid . '/' . $video->processed_file)}}"
                        ...
                        <div class="course__meta-2 d-sm-flex align-items-center mb-10">
                            <div class="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                                ...
                                <div class="course__teacher-info-3">
                                    ...
                                    <p><a href="#">{{$video->course->instructor}}</a></p>
                                </div>
                            </div>
                            <div class="course__update mr-80 mb-30">
                                <h5>{{trans('site.Last_Update')}}:</h5>
                                <p>{{$video->updated_at->format('M d, Y h:i A')}}</p>
                            </div>
                            <div class="course__update mr-80 mb-30">
                                <h5>{{trans('site.Created_at')}}:</h5>
                                <p>{{$video->created_at->format('M d, Y h:i A')}}</p>
                            </div>

                        </div>
                        <h3 class="breadcrumb__title-2">{{$video->title}}</h3>
                    </div>
                    <div class="course__tab-content mb-95">
                        <div class="tab-content" id="courseTabContent">
                            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                <div class="course__description">
                                    <h3 class="ml-30">{{trans('videos.Description')}}:</h3>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 " >
                    <div class="blog__sidebar pl-70">
                        ...
                        <div class="sidebar__widget mb-55" >
                            ...
                            <div class="sidebar__widget-content" style="overflow-y:auto;  height:300px;">
                                <div class="rc__post-wrapper">


                                    @forelse($course->videos->where('visibility','public') as $videos )
                                        <div class="rc__post d-flex align-items-start mb-5">
                                            <div class="rc__title mr-20 mt-20"><a
                                                    href="{{route('videos',[$course->id,$videos->id])}}">{{$loop->iteration}}</a><br>

                                            </div>
                                            <div class="rc__thumb mr-20" style="position: relative;">
                                                <a href="{{route('videos',[$course->id,$videos->id])}}">
                                                    @if($videos->thumbnail)
                                                        <img
                                                            src="{{asset($videos->thumbnail)}}"
                                                            width="60" height="60" alt="{{$videos->title}}">
                                            ...
                                            <div class="rc__content">
                                                <div class="rc__meta">
                                                    <a href="{{route('videos',[$course->id,$videos->id])}}">{{$videos->title}} </a>
                                                </div>

                                                @if($videos->id == $video->id )

                                                <h6 class="rc__title"><a
                                                        href="{{route('videos',[$course->id,$videos->id])}}"> <small style="font-size: 12px; color: #0a53be"><i class="fas fa-play-circle"></i> playing now</small></a><br>

                                                              <small>{{$videos->created_at->diffForHumans()}}</small>
                                                </h6>
                                                @else
                                                    <h6 class="rc__title"><a
                                                            href="{{route('videos',[$course->id,$videos->id])}}"></a>
                                                        <span><small>{{$videos->created_at->diffForHumans()}}</small></span>
                                                    </h6>
                                                @endif
