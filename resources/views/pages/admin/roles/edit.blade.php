                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.roles.update')}}" method="post">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" name="name" value="{{$role->name}}" type="text" placeholder="الوظيفة"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div>
                                                                ...
                                                                <div class="form-check mb-3">
                                                                    <input class="form-check-input" value="{{$name}}" {{in_array($name,$role->permissions) ? 'checked' : ''}} name="permissions[]"
                                ...
                                <div>
                                    <button class="btn btn-primary" type="submit">{{trans('roles.Saving_changes')}}</button>
                                </div>
                            </form>
